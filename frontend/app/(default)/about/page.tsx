      ...
      <section className="py-24 px-6 sm:px-10 border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-12 gap-12">
          ...
          <div className="sm:col-span-8 space-y-6 text-white/50 text-lg font-light leading-relaxed">
            ...
            <p>
              This project generates <strong className="text-white/80">symbolic music</strong>: MIDI sequences where every note is a discrete event with a pitch, a start time, a duration, and a velocity. Think of it as the difference between a screenshot and an SVG. One is flat pixels. The other is individual shapes you can select, move, and restyle. You can select individual notes, transpose sections, swap instruments, adjust timing, and drop the output straight into a DAW like Ableton or Logic as a starting point for real composition.
            </p>
            <p>
